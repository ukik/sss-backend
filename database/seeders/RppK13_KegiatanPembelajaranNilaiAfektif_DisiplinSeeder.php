...
# php artisan db:seed --class=RppK13_KegiatanPembelajaranNilaiAfektif_DisiplinSeeder

use Carbon\Carbon;

class RppK13_KegiatanPembelajaranNilaiAfektif_DisiplinSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('rpp_k13_kegiatan_pembelajaran_nilai_afektif_disiplin')->truncate();
        ...
        function poin($siswa_id) {
            $poins = \PoinAfektifPsikomotor::where('tipe','k2')->where('label','disiplin')->get();
        ...
        foreach ($rpps as $key => $rpp) {
            ...
            \RppK13_KegiatanPembelajaranNilaiAfektif_Disiplin::updateOrCreate([ 'uuid' => $uuid ], $form);
