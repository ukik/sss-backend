...
# php artisan db:seed --class=RppK13_KegiatanPembelajaranNilaiAfektif_AkhlakSeeder

use Carbon\Carbon;

class RppK13_KegiatanPembelajaranNilaiAfektif_AkhlakSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('rpp_k13_kegiatan_pembelajaran_nilai_afektif_akhlak')->truncate();
        ...
        function poin($siswa_id) {
            $poins = \PoinAfektifPsikomotor::where('tipe','k1')->where('label','akhlak')->get();
        ...
        foreach ($rpps as $key => $rpp) {
            ...
            \RppK13_KegiatanPembelajaranNilaiAfektif_Akhlak::updateOrCreate([ 'uuid' => $uuid ], $form);
