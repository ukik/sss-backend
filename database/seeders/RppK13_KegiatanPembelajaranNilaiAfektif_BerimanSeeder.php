...
# php artisan db:seed --class=RppK13_KegiatanPembelajaranNilaiAfektif_BerimanSeeder

use Carbon\Carbon;

class RppK13_KegiatanPembelajaranNilaiAfektif_BerimanSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('rpp_k13_kegiatan_pembelajaran_nilai_afektif_beriman')->truncate();
        ...
        function poin($siswa_id) {
            $poins = \PoinAfektifPsikomotor::where('tipe','k1')->where('label','beriman')->get();
        ...
        foreach ($rpps as $key => $rpp) {
            ...
            \RppK13_KegiatanPembelajaranNilaiAfektif_Beriman::updateOrCreate([ 'uuid' => $uuid ], $form);
