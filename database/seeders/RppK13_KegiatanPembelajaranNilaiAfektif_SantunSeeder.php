...
# php artisan db:seed --class=RppK13_KegiatanPembelajaranNilaiAfektif_SantunSeeder

use Carbon\Carbon;

class RppK13_KegiatanPembelajaranNilaiAfektif_SantunSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('rpp_k13_kegiatan_pembelajaran_nilai_afektif_santun')->truncate();
        ...
        foreach ($rpps as $key => $rpp) {
            ...
            \RppK13_KegiatanPembelajaranNilaiAfektif_Santun::updateOrCreate([ 'uuid' => $uuid ], $form);
