...
# php artisan db:seed --class=RppK13_KegiatanPembelajaranNilaiAfektif_JujurSeeder

use Carbon\Carbon;

class RppK13_KegiatanPembelajaranNilaiAfektif_JujurSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('rpp_k13_kegiatan_pembelajaran_nilai_afektif_jujur')->truncate();
        ...
        function poin($siswa_id) {
            $poins = \PoinAfektifPsikomotor::where('tipe','k2')->where('label','jujur')->get();
        ...
        foreach ($rpps as $key => $rpp) {
            ...
            \RppK13_KegiatanPembelajaranNilaiAfektif_Jujur::updateOrCreate([ 'uuid' => $uuid ], $form);
