...
# php artisan db:seed --class=RppK13_KegiatanPembelajaranNilaiAfektif_PercayaDiriSeeder

use Carbon\Carbon;

class RppK13_KegiatanPembelajaranNilaiAfektif_PercayaDiriSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('rpp_k13_kegiatan_pembelajaran_nilai_afektif_percaya_diri')->truncate();
        ...
        function poin($siswa_id) {
            $poins = \PoinAfektifPsikomotor::where('tipe','k2')->where('label','peduli')->get();
        ...
        foreach ($rpps as $key => $rpp) {
            ...
            \RppK13_KegiatanPembelajaranNilaiAfektif_PercayaDiri::updateOrCreate([ 'uuid' => $uuid ], $form);
