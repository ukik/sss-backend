...
# php artisan db:seed --class=RppK13_KegiatanPembelajaranNilaiPsikomotorSeeder

use Carbon\Carbon;

class RppK13_KegiatanPembelajaranNilaiPsikomotorSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('rpp_k13_kegiatan_pembelajaran_nilai_psikomotor')->truncate();
        ...
        function poin($siswa_id) {
            $poins = \PoinAfektifPsikomotor::where('tipe','k3')->get();
        ...
        foreach ($rpps as $key => $rpp) {
            ...
            \RppK13_KegiatanPembelajaranNilaiPsikomotor::updateOrCreate([ 'uuid' => $uuid ], $form);
