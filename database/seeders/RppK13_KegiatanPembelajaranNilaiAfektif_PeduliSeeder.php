...
# php artisan db:seed --class=RppK13_KegiatanPembelajaranNilaiAfektif_PeduliSeeder

use Carbon\Carbon;

class RppK13_KegiatanPembelajaranNilaiAfektif_PeduliSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('rpp_k13_kegiatan_pembelajaran_nilai_afektif_peduli')->truncate();
        ...
        foreach ($rpps as $key => $rpp) {
            ...
            \RppK13_KegiatanPembelajaranNilaiAfektif_Peduli::updateOrCreate([ 'uuid' => $uuid ], $form);
